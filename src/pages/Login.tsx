        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-[#0a0a0a] border border-blue-600/50 text-white rounded-md hover:border-blue-500 transition-all font-mono"
            >
